...
const LinkCategories = (): JSX.Element => {
    ...
    const loadCategories = async () => {
        const [data, error] = await Api.Get<LinkCategory[]>('links/categories');
    ...
    const deletePodcastCategory = async (id: number) => {
        ...
        const [, error] = await Api.Delete(`links/categories/${id}`);
                ...
                <Space direction={isLargeScreen ? 'horizontal' : 'vertical'} size={isLargeScreen ? 16 : 8}>
                    ...
                    {category.linkCount > 0 ? (
                        ...
                        <Confirmation
                            ...
                            onConfirm={() => deletePodcastCategory(category.linkCategoryId)}
                        >
                            <Button
                                type="link"
                                htmlType="button"
